...
public class MainRightAdapter extends RecyclerView.Adapter<MainRightViewHolder>
{
    ...
    String token;
    int position2;
    public MainRightAdapter(NavigationActivity mContext, View.OnClickListener clickListener, ArrayList<pastWeekInfo> pastweek, thisWeekInfo thisWeekInfo) {
    ...
    // 뷰홀더 객체 생성
    @Override
    public MainRightViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_left_item, parent, false);
        MainRightViewHolder productViewHolder = new MainRightViewHolder(view); // 뷰홀더를 통해 메모리 할당
    ...
    @Override
    public void onBindViewHolder(final MainRightViewHolder holder, int position)
    {
        position2 = position;
