...
public class RecommendContentsFragment extends MasterFragment/* implements OnMapReadyCallback*/ {
    ...
    FragmentManager googleMapManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        googleMapManager = getFragmentManager();
        googleMap = (SupportMapFragment)this.getChildFragmentManager().findFragmentById(R.id.google_map_recommend_contents);
                ...
                if (response.isSuccessful()) {
                    ...
                    googleMap.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(GoogleMap googleMap) {
                            LatLng restaurantLocation = new LatLng(data.locationLatitude,data.locationLongtitude);
                            MarkerOptions markerOptions = new MarkerOptions();
                            markerOptions.position(restaurantLocation).title(data.title);
