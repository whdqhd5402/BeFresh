...
public class MyRecipeAdapter extends RecyclerView.Adapter<MyRecipeVH> {
    ...
    ArrayList<getRecipePhoto.ResultData> items = new ArrayList<>();
    ...
    public MyRecipeAdapter(NavigationActivity context, ArrayList<getRecipePhoto.ResultData> items, View.OnClickListener clickListener)
    {
    ...
    @Override
    public MyRecipeVH onCreateViewHolder(ViewGroup parent, int i)
    {
        View view = LayoutInflater.from(context).inflate(R.layout.view_item_my_recipe, parent, false);
        view.setOnClickListener(clickListener);
        return new MyRecipeVH(view);
    }

    @Override
    public void onBindViewHolder(final MyRecipeVH holder, int position) {
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                check(holder.id);
                Toast.makeText(context, holder.like.isChecked()?"나의 목록에 추가 되었습니다.":"나의 목록에서 삭제 되었습니다.", Toast.LENGTH_SHORT).show();
            }
        });
    }
